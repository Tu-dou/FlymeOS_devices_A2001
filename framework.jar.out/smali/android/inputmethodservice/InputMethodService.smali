...
.method static synthetic access$200(Landroid/inputmethodservice/InputMethodService;)Lcom/android/internal/statusbar/IStatusBarService;
    .locals 1
    .param p0, "x0"    # Landroid/inputmethodservice/InputMethodService;

    .prologue
    .line 230
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->getStatusBarService()Lcom/android/internal/statusbar/IStatusBarService;
...
.method static synthetic access$302(Landroid/inputmethodservice/InputMethodService;Lcom/android/internal/statusbar/IStatusBarService;)Lcom/android/internal/statusbar/IStatusBarService;
    .locals 0
    .param p0, "x0"    # Landroid/inputmethodservice/InputMethodService;
...
.method private getEdgeGestureService()Landroid/service/gesture/IEdgeGestureService;
    ...
    .line 2320
    :try_start_0
    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mEdgeGestureService:Landroid/service/gesture/IEdgeGestureService;
    ...
    iput-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mEdgeGestureService:Landroid/service/gesture/IEdgeGestureService;
...
.method public hideWindow()V
    ...
    invoke-virtual {v3}, Landroid/inputmethodservice/SoftInputWindow;->hide()V
    ...
    .line 1585
    :cond_0
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->getEdgeGestureService()Landroid/service/gesture/IEdgeGestureService;
    ...
    :try_start_0
    invoke-interface {v1, v3}, Landroid/service/gesture/IEdgeGestureService;->setImeIsActive(Z)V
    :try_end_0
    ...
    const-string v4, "keyboard_rotation_timeout"

    const/4 v5, -0x3

    invoke-static {v3, v4, v6, v5}, Landroid/provider/Settings$PAC;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 1597
    iget-object v3, p0, Landroid/inputmethodservice/InputMethodService;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Landroid/inputmethodservice/InputMethodService;->restoreAutoRotation:Ljava/lang/Runnable;

    invoke-virtual {v3, v4}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 1598
    iget-boolean v3, p0, Landroid/inputmethodservice/InputMethodService;->mForcedAutoRotate:Z
    ...
    iput-object v3, p0, Landroid/inputmethodservice/InputMethodService;->mEdgeGestureService:Landroid/service/gesture/IEdgeGestureService;
...
.method public showWindow(Z)V
    ...
    :try_start_1
    invoke-interface {v1, v5}, Landroid/service/gesture/IEdgeGestureService;->setImeIsActive(Z)V
    :try_end_1
    ...
    const-string v7, "keyboard_rotation_timeout"

    invoke-static {v5, v7, v6, v8}, Landroid/provider/Settings$PAC;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    :try_start_3
    iput-object v5, p0, Landroid/inputmethodservice/InputMethodService;->mEdgeGestureService:Landroid/service/gesture/IEdgeGestureService;
    :try_end_3
...
.method public updateFullscreenMode()V
    ...
    invoke-static {v6, v9, v8, v10}, Landroid/provider/Settings$PAC;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
